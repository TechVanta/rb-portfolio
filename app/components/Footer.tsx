...
const socialLinks = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/ravibhalala11795",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/ravibhalala",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "https://www.linkedin.com/in/ravi-bhalala-97440111a/", label: "LinkedIn" },
      { href: "https://github.com/ravibhalala11795", label: "GitHub" },
    ],
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800">
          <p className="text-sm text-zinc-500 dark:text-zinc-400 text-center">
            © {new Date().getFullYear()} Ravi Bhalala. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
